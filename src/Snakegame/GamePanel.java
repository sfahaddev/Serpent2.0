...
private int[] yPos={100,125,150, 175, 200, 225, 250, 275, 300, 325, 350, 375,400,425 ,450,475,500,
    ...
    public void paint(Graphics g) { // is panel se graphic draw hon ge
       ...
       //g.fillRect(25, 75, 850, 575); // snake jaha hoga waha ka size
        ...
        if(moves == 0){ // when the game start
            snakexlenght[0]=500; // this is snake head
            snakexlenght[1]=475;
            snakexlenght[2]=450;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for(int i = lenghtofsnake-1;i>0;i--){// by this we remove the last tail of snake to add new and
            snakexlenght[i]=snakexlenght[i-1]; // show its moving
    ...
    if (snakexlenght[0] > 837) snakexlenght[0] = 23; // this is for ek jagha se jae dusri se aie
    if (snakexlenght[0] < 23) snakexlenght[0] = 837;
        
        if (snakeylenght[0]>625)snakeylenght[0]=100; // this is for ek jagha se jae dusri se aie
        if (snakeylenght[0]<100)snakeylenght[0]=625; // this is for ek jagha se jae dusri se aie
...
// for snake movement
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(gameOver && (e.getKeyCode()==KeyEvent.VK_SHIFT ||e.getKeyCode()==KeyEvent.VK_ENTER)){//restarts only when the game is over
            restart();
        }
...
// when snakes eats the food and to generate new food
    ...
    if (snakexlenght[0] == enemyX && snakeylenght[0] == enemyY) {
        newEnemy();
        lenghtofsnake++;
        score++;
    }
